        ...
        >
            ...
            {message.reply_to_id && message.reply_message && (
                <div className={clsx(
                    ...
                    <span className="truncate italic">
                        {message.reply_message.content || (message.reply_message.image_url ? t('chat.image_message') : '')}
                    </span>
                </div>
            )}
            ...
            >
                ...
                <div className={clsx(
                    ...
                    {message.edited_at && <span className="text-[9px] italic mr-1">({t('common.edited')})</span>}
