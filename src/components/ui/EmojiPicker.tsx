...
const EMOJI_DATA: EmojiCategory[] = [
    ...
    },
    {
        id: 'objects',
        icon: <Lamp size={18} />,
        emojis: ['⌚️', '📱', '📲', '💻', '⌨️', '🖥', '🖨', '🖱', '🖲', '🕹', '🗜', '💽', '💾', '💿', ' DVD', '📼', '📷', '📸', '📹', '🎥', '📽', '🎞', '📞', '☎️', '📟', '📠', '📺', '📻', '🎙', '🎚', '🎛', '🧭', '⏱', '⏲', '⏰', '🕰', '⌛️', '⏳', '📡', '🔋', '🔌', '💡', '🔦', '🕯', '🪔', '🧯', '🛢', '💸', '💵', '💴', '💶', '💷', '🪙', '💰', '💳', '💎', '⚖️', '🪜', '🧰', '🪛', '🔧', '🔨', '⚒', '🛠', '⛏', '🪚', '🔩', '⚙️', '🪝', '🧱', '⛓', '🧲', '🔫', '💣', '🧨', '🪓', '🔪', '🗡', '⚔️', '🛡', '🚬', '⚰️', '🪦', '⚱️', '🏺', '🔮', '📿', '🧿', '💈', '⚗️', '🔭', '🔬', '🕳', '🩹', '🩺', '💊', '💉', '🩸', '🧬', '🦠', '🧫', '🧪', '🌡', '🧹', '🪠', '🧺', '🧻', '🚽', '🚰', '🚿', '🛀', '🛁', '🧼', '🪥', '🪒', '🧽', '🪣', '🧴', '🛎', '🔑', '🗝', '🚪', '🪑', '🛋', '🛏', '🛌', '🧸', '🪆', '🖼', '🪞', ' window', '🛍', '🛒', '🎁', '🎈', '🎏', '🎀', '🪄', '🎊', '🎉', '🎎', '🏮', '🎐', '🧧', '✉️', '📩', '📨', '📧', '💌', '📥', '📤', '📦', '🏷', '🪧', '📪', '📫', '📬', '📭', '📮', '🗳', '📜', '📃', '📄', '📅', '📆', '🗓', '📇', '📈', '📉', '📊', '📋', '📌', '📍', '📎', '🖇', '📏', '📐', '✂️', '🗃', '🗄', '🗑', '🔒', '🔓', '🔏', '🔐', '🔑', '🗝']
    },
    {
        id: 'symbols',
...
export const EmojiPicker = ({ onSelect, onClose, className }: EmojiPickerProps) => {
    ...
    const displayEmojis = search
        ? EMOJI_DATA.flatMap(cat => cat.emojis).filter(emoji => emoji.includes(search)).slice(0, 140)
            ...
            <div className="p-4 bg-surface/40 border-b border-outline-variant/10">
                <div className="relative mb-4">
                    ...
                    <input
                        ...
                        className="w-full bg-surface-container rounded-2xl pl-10 pr-4 py-2 text-sm font-medium border-none focus:ring-2 focus:ring-primary/20 outline-none placeholder:text-on-surface-variant/30"
                    />
                </div>
